        ...
        <div className="container">
          <div className="row">
            ...
            <div className="headerlinkmenu col-lg-8 col-md-7 col-sm-8 col-xs-12">
              <div className="links">
                 <Link to='/my_account'><div className="myaccount"><a title="My Account" href="account_page.html"><i className="fa fa-user" style={{color:"#FFFFFF"}}></i><span className="hidden-xs">My Account</span></a></div></Link>
                    ...
                    <div className='show_mini_cart'>
                      <div className="top-cart-content">
                        ...
                        <div className="actions">
                          <button className="btn-checkout" type="button"><i className="fa fa-check"></i><span>Checkout</span></button>
                          <button className="view-cart" type="button"><i className="fa fa-shopping-cart"></i> <span>View Cart</span></button>
                        </div>
                      </div>
                    </div>
                  </div>
