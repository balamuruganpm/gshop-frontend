      ...
      <div className="row"> 
        ...
        <div className="col-sm-8 col-md-9 col-xs-12">
          <div className="home-tab">
            <ul className=" home-nav-tabs home-product-tabs">
            ...
            <div id="productTabContent" className="tab-content">
              <div className="tab-pane active in" id="featured">
                ...
                <div id="related-product-slider" className="slider-items  slider-width-col4">
                            ...
                            <div className="item-inner" id="featured_inner">
                ...
                <div className="item-inner" id="featured_inner">
                  <div className="product-thumb has-hover-img"> <a title="Ipsums Dolors Untra" href="single_product.html">
                    <figure> <img src="images/a2.jpg" alt=""/> <img className="hover-img" src="images/z4.jpg" alt=""/></figure>
                    </a>
                    <div className="pr-info-area animated animate2"><a href="quick_view.html" className="quick-view"><i className="fa fa-search"><span>Quick view</span></i></a> <a href="wishlist.html" className="wishlist"><i className="fa fa-heart"><span>Wishlist</span></i></a> <a href="compare.html" className="compare"><i className="fa fa-exchange"><span>Compare</span></i></a> </div>
                  </div>
                  <div className="item-info">
                ...
                <div className="item-inner" id="featured_inner">
                  <div className="product-thumb has-hover-img"> <a title="Ipsums Dolors Untra" href="single_product.html">
                    <figure> <img src="images/a4.jpg" alt=""/> <img className="hover-img" src="images/z3.jpg" alt=""/></figure>
                    </a>
                    <div className="pr-info-area animated animate2"><a href="quick_view.html" className="quick-view"><i className="fa fa-search"><span>Quick view</span></i></a> <a href="wishlist.html" className="wishlist"><i className="fa fa-heart"><span>Wishlist</span></i></a> <a href="compare.html" className="compare"><i className="fa fa-exchange"><span>Compare</span></i></a> </div>
                  </div>
                  <div className="item-info">
