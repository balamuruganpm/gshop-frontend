               ...
               <div className="product-item" key={product._id}>
                <div class="item-inner">
                  <div class="product-thumb has-hover-img"> <Link to={`/product/${product._id}`}>
                    ...
                    <div class="pr-info-area animated animate2"><a href="quick_view.html" class="quick-view"><i class="fa fa-search"><span>Quick view</span></i></a> <a 
                      onClick={()=>
